        ...
        it("should work perfectly", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    const loadedLog = await connection.manager.findOneOrFail(
                        ActionLog,
                        {
                    ...
                    loadedLog.actionDetails.description.should.be.equal(
                        "Test Details #1",
                    )
