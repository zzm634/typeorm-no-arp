                ...
                connections.map(async (connection) => {
                    ...
                    let loadedPosts = await connection.manager
                        ...
                        .loadRelationIdAndMap(
                            ...
                            (qb) =>
                                qb.andWhere(
                                    "category.id = :id AND category.code = :code",
                                    { id: 1, code: 1 },
                                ),
                        )
                        .getMany()
        ...
        it("should load ids when loadRelationIdAndMap used on nested relation", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    expect(
                        loadedPosts[0].categories[0].imageIds[0],
                    ).to.be.equal(1)
                    expect(
                        loadedPosts[0].categories[0].imageIds[1],
                    ).to.be.equal(2)
                    expect(
                        loadedPosts[0].categories[0].imageIds[2],
                    ).to.be.equal(3)
                    expect(loadedPosts[1].categoryIds).to.not.be.eql([])
                    ...
                    expect(
                        loadedPosts[1].categories[0].imageIds[0],
                    ).to.be.equal(4)
                    expect(
                        loadedPosts[1].categories[0].imageIds[1],
                    ).to.be.equal(5)
                    ...
                    expect(
                        loadedPosts[1].categories[1].imageIds[0],
                    ).to.be.equal(5)
                ...
                connections.map(async (connection) => {
                    ...
                    let loadedCategories = await connection.manager
                        ...
                        .loadRelationIdAndMap(
                            ...
                            (qb) =>
                                qb.andWhere(
                                    "post.id = :id AND post.authorId = :authorId",
                                    { id: 1, authorId: 1 },
                                ),
                        )
                        .getMany()
        ...
        it("should load ids when loadRelationIdAndMap used on nested relation", () =>
            Promise.all(
                connections.map(async (connection) => {
                    ...
                    expect(
                        loadedImages[0].categories[0].postIds.length,
                    ).to.be.equal(2)
                    ...
                    expect(
                        loadedImages[0].categories[1].postIds.length,
                    ).to.be.equal(1)
                    ...
                    expect(
                        loadedImages[1].categories[0].postIds.length,
                    ).to.be.equal(2)
