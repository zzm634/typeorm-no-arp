    ...
    it("all types should work correctly - persist and hydrate", () =>
        Promise.all(
            connections.map(async (connection) => {
                ...
                loadedPost.timestampWithoutTimeZone
                    .getTime()
                    .should.be.equal(post.timestampWithoutTimeZone.getTime())
                ...
                table!
                    .findColumnByName("timeWithoutTimeZone")!
                    .type.should.be.equal("time")
                table!
                ...
                table!
                    .findColumnByName("timestampWithoutTimeZone")!
                    .type.should.be.equal("timestamp")
                table!
