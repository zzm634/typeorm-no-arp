    ...
    it("all types should work correctly - persist and hydrate", () =>
        Promise.all(
            connections.map(async (connection) => {
                ...
                loadedPost.varyingCharacter.should.be.equal(
                    post.varyingCharacter,
                )
                ...
                table!
                    .findColumnByName("mediumint")!
                    .type.should.be.equal("mediumint")
                table!
                    .findColumnByName("bigint")!
                    .type.should.be.equal("bigint")
                table!
                    .findColumnByName("unsignedBigInt")!
                    .type.should.be.equal("unsigned big int")
                table!
                ...
                table!
                    .findColumnByName("varyingCharacter")!
                    .type.should.be.equal("varying character")
                table!.findColumnByName("nchar")!.type.should.be.equal("nchar")
                table!
                    .findColumnByName("nativeCharacter")!
                    .type.should.be.equal("native character")
                table!
